export interface PhonePeOptions {
  redirectUrl: string
  redirectMode: 'REDIRECT' | 'POST' | string
  callbackUrl: string
  merchantId: string
  salt: string
  mode: 'production' | 'test' | 'uat' | string
...
export type PhonePeS2SResponsePaymentInstrument = PhonePeS2SResponsePaymentInstrumentUpi &
